...
def listar_trechos():
    trechos_filtrados = [rota for rota in carregar_rotas(3)]
...
def comprar_trecho():
    ...
    trecho = next((rota for rota in carregar_rotas(3) if rota['ID'] == trecho_id), None)
    if trecho:
        pass
...
# FUNÇÃO PARA QUE O SERVIDDOR C CONSULTE OUTROS SERVIDORES
